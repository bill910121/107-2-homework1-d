...
(1)下降 (2)1.1百分點 (3)低 (4)upward bias (5)正向 (6)高 (7)高與低 (8)高
...
$$\begin{equation*}
\begin{split}
\sum_{i,x_i=1}^n (x_i-\bar{x})^2
&=\sum_{i,x_i=1}^n ((x_i)^2-2x_i\bar{x}+\bar{x}^2
=\sum_{i,x_i=1}^n x_i ^2 -2\bar{x}\sum_{i,x_i=1}^n x_i +n\bar{x}^2\\
&=\sum_{i,x_i=1}^n x_i ^2 -2n\bar{x}^2+n\bar{x}^2
=\sum_{i,x_i=1}^n x_i ^2 -n\bar{x}^2\\
...
\begin{split}
\hat{\beta_1}
&=\frac{\sum_{i=1}^n (x_i-\bar{x})y_i}{\sum_{i=1}(x_i-\bar{x})}\\
&=\frac{\sum_{i=1}^n x_iy_i-n\bar{y}}{\frac{n_0 n_1}{n_0 + n_1}} \\
...
\begin{split}
\hat{\beta_1}
&=\frac{\sum_{i=1}^n (x_i-\bar{x})(y_i-{\bar{y}})}{\sum_{i=1}(x_i-\bar{x})^2}
=\frac{\sum_{i=1}^n (x_i-\bar{x})y_i}{\sum_{i=1}(x_i-\bar{x})}\\
&=\frac{\sum_{i=1}^n (x_i-\bar{x})(\beta_0+\beta_1x_i+u_i)}{\sum_{i=1}(x_i-\bar{x})}\\
&=\frac{\beta_0}{\sum_{i=1}^n(x_i-\bar{x})^2}\sum_{i=1}^nx_i-\bar{x}
+\frac{\beta_1}{\sum_{i=1}(x_i-\bar{x})^2}\sum_{i=1}(x_i-\bar{x})
+\frac{\sum_{i=1}^n(x_i-\bar{x})u_i}{\sum_{i=1}^n(x_i-\bar{x})^2}\\
&=0+\frac{\beta_1}{\sum_{i=1}(x_i-\bar{x})^2}\sum_{i=1}(x_i-\bar{x})^2
+\frac{\sum_{i=1}^n(x_i-\bar{x})u_i}{\sum_{i=1}^n(x_i-\bar{x})^2}\\
...
\begin{split}
E(\hat{\beta}_1)
=E(\beta_1+\frac{\sum_{i=1}^n(x_i-\bar{x})u_i}{\sum_{i=1}^n(x_i-\bar{x})^2})=\beta_1+\frac{\sum_{i=1}^n(x_i-\bar{x})E(u_i)}{\sum_{i=1}^n(x_i-\bar{x})^2}
=\beta_1
\end{split}
\end{equation*}$$
...
\begin{split}
Var(\hat{\beta}_1)
&=E(\beta_1+\frac{\sum_{i=1}^n(x_i-\bar{x})u_i}{\sum_{i=1}^n(x_i-\bar{x})^2})=\beta_1+\frac{\sum_{i=1}^n(x_i-\bar{x})Var(u_i)}{\sum_{i=1}^n(x_i-\bar{x})^2}\\
&=\frac{\sigma^2}{\sum_{i=1}^n(x_i-\bar{x})^2}
=\frac{\sigma^2}{\frac{n_0 n_1}{n_0+n_1}}\\
